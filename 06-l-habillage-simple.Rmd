...
Il est aussi possible de rajouter des annotations de type texte ou autre, par exemple, "à la volée". La fonctions `annotate()` va nous permettre de rajouter nos annotations. Ici nous rajoutons une fonction pour rajoute un texte, une autre pour rajouter une flèche.
