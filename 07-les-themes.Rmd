...
La fonction [theme()](http://ggplot2.tidyverse.org/reference/theme.html) permet de modifier l'apparence d'un graphique, c'est-à-dire de définir tout ce qui n'est pas lié directement aux données sur un graphique, notamment: 

- la position, taille, couleur, police des éléments textuels

- la couleur et le type des grilles primaires et secondaires du graphique
...
Le schéma de [Heny Wang](https://henrywang.nl/ggplot2-theme-elements-demonstration/) synthétise l'ensemble de ces élements et composantes.

![](images/theme.PNG){#id .class width=500}
